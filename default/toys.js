...
const defaultToys = [
    ...
    },
    {
        ...
        price: 12.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Educational", "Wooden", "Puzzle", "Colorful"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 18.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Action Figure", "Superhero", "Dynamic", "Collectible"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 20.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Board Game", "Family", "Strategy", "Interactive"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 29.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Remote-Controlled", "Car", "Electronic", "Speed"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 45.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Dollhouse", "Miniature", "Intricate", "Imaginative Play"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 22.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Musical", "Instruments", "Educational", "Colorful"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 120.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Outdoor", "Swing Set", "Playground", "Active Play"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 9.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Yo-Yo", "Skill Toy", "Vibrant", "Hand-Eye Coordination"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 24.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Wooden Train", "Classic Toy", "Collectible", "Imaginative"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 5.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Rubber Duck", "Bath Toy", "Water Play", "Colorful"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 39.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Model Airplane", "Detailed", "Collectible", "Aviation"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 17.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Unicorn", "Plush Toy", "Soft", "Fantasy"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 11.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Puzzle Cube", "Brain Teaser", "Colorful", "Challenging"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 14.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Panda Pillow", "Soft", "Cuddly", "Animal-Shaped"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 29.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Electronic Train", "Realistic", "Modern", "Toy Vehicle"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 21.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Electronic", "Robotics", "Interactive", "Futuristic"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 16.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Fantasy", "Fairy", "Imaginative Play", "Dolls"]
    },
    {
        _id: utilService.makeId(),
        name: "Colorful Kite",
        ...
        price: 13.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Outdoor", "Flight", "Colorful", "Wind Play"]
    },
    {
        _id: utilService.makeId(),
        ...
        price: 7.99,
        stock: Math.max(utilService.getRandInt(16, -4), 0),
        labels: ["Miniature", "Vehicle", "Collectible", "Realistic"]
    }
]